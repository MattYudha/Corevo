    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Konfigurasi Master Presence</h3>
                <p class="text-subtitle text-muted">Kelola aturan jam kerja, batas keterlambatan, dan keamanan jaringan presensi secara terpusat.</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('presences.index') }}">Presensi</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Pengaturan Master</li>
                    </ol>
                </nav>
            </div>
        </div>
