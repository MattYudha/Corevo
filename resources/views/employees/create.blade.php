                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="employee_status" class="form-select" required>
                                                @foreach (\App\Models\Employee::getAvailableStatuses() as $key => $label)
                                                    <option
                                                        value="{{ $key }}"
                                                        {{ old('employee_status') == $key ? 'selected' : '' }}
                                                        >{{ $label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="working_type" class="form-select" required>
                                                <option
                                                    value="full_time"
                                                    {{ old('working_type') == 'full_time' ? 'selected' : '' }}
                                                    >Full Time
                                                </option>
                                                <option
                                                    value="part_time"
                                                    {{ old('working_type') == 'part_time' ? 'selected' : '' }}
                                                    >Part Time
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">
                                                Enter the monthly PPh21 tax deduction percentage specifically for this
                                                employee.
                                            </small>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            />
                                            <small class="text-muted"
                                                >This password will be used for the employee's login account.</small
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="office_location_id" class="form-select" required>
                                                ...
                                                @foreach ($officeLocations as $officeLocation)
                                                    <option
                                                        ...
                                                        {{
                                                            old('office_location_id') == $officeLocation->id
                                                                ? 'selected'
                                                                : ''
                                                        }}
                                                    >
                                            ...
                                            <small class="text-muted"
                                                >Lokasi kerja ini dipakai untuk pengaturan WFO dan presensi.</small
                                            >
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted"
                                                >KPI and approval requests will be sent to this person.</small
                                            >
                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <h5 class="mb-0 fw-bold text-success" id="modal_total_text">
                                                                Rp 0
                                                            </h5>
                                                        </div>
                                                    </div>
