                                ...
                                <div class="form-check form-switch d-flex align-items-start mb-0">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-muted">
                                            ...
                                            deductions will be reset to <strong>0</strong>. The employee will receive
                                            only the <strong>Base Salary</strong>.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-body border p-4 rounded-3 shadow-sm mb-4">
                                <table class="table table-borderless mb-0">
                                    <tr>
                                        ...
                                        <td class="text-end fs-5 text-success fw-bold py-2" id="summary-earnings">
                                            Rp 0
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="fw-semibold fs-6 text-secondary py-2">Total Deductions</td>
                                        <td class="text-end fs-5 text-danger fw-bold py-2" id="summary-deductions">
                                            Rp 0
                                        </td>
                                    </tr>
