    ...
    <div class="page-heading mb-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
            <div class="d-flex align-items-center order-2 order-md-1 mt-3 mt-md-0">
                ...
                <div>
                    <h3 class="mb-0">Create Letter Template</h3>
                    <p class="text-subtitle text-muted mb-0 mt-1">Create a new letter template along with dynamic variables.</p>
                </div>
            </div>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-header order-1 order-md-2">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create Letter Template</li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <form action="{{ route('letter-templates.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        name="name"
                                        value="{{ old('name') }}"
                                        placeholder="Example: Warning Letter"
                                        required
                                    />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="memo" {{ old('type') == 'memo' ? 'selected' : '' }}
                                            >Memorandum
                                        </option>
                                        <option value="notice" {{ old('type') == 'notice' ? 'selected' : '' }}
                                            >Notice
                                        </option>
                                    </select>
                                </div>
